...
, background: c.surface2, color: c.text, fontSize: 15, marginBottom: 16 };
...
        <input style={{ ...inputStyle, marginBottom: 20 }} type="password" placeholder="Senha (min. 6 caracteres)" value={senha} onChange={(e) => setSenha(e.target.value)} />
